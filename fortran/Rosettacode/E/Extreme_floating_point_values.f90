!   Fortran
!u# https://rosettacode.org/wiki/Extreme_floating_point_values
!c# 2024-02-27 
...
!      PARAMETER (NaN4 = Z'FFFFFFFF')    !FFFFFFFF
      REAL*8 NaN8,X8(5),Y8,INF8
      PARAMETER (NaN8 = Z'FFF8000000000000')    !FFFFFFFF
!      PARAMETER (NaN8 = Z'FFFFFFFFFFFFFFFF')
      LOGICAL LX(5)
      INTEGER I
      X4 = NaN4
      WRITE (6,1) X4,IX4
...
!      WRITE (6,*) "Test mod(x,Bad) ",MOD(XX,X4)
!      WRITE (6,*) "Test mod(Bad,x) ",MOD(X4,XX)
!      WRITE (6,*) "Test mod(x,0)   ",MOD(XX,Z)
!      WRITE (6,*) "Sqrt(Bad)",SQRT(X4)
   ...
   10   FORMAT (I3,"/",I3," gives",F9.5," Hex ",Z8,", Sqrt(",I3,") gives",F9.5," Hex ",Z8)
      END DO
...
!Contemplate double precision.
      ...
      WRITE (6,*) "isnan(x(2))..(4))",ISNAN(X8(2)),ISNAN(X8(3)), ISNAN(X8(4))
