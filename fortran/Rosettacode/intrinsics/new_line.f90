...
integer :: i, count
  ...
  ! basics
   ...
   string= 'This is record 1.' // nl // 'This is record 2.' // new_line('a') // 'This is record 3.'
   write(*,'(a)') string

   ! print a newline character string
  !write(*,'(*(a))',advance='no') nl,'This is record 1.',nl, 'This is record 2.', new_line('a'), 'This is record 3.',  ! no
   write(*,'(*(a))',advance='no') nl,'This is record 1.',nl,'This is record 2.',nl
