...
!  The upper bound in the last dimension must appear in the reference to the assumed size array (gfortran)
!  A dim= argument is required for 'size' when the array is assumed-size  (flang)
