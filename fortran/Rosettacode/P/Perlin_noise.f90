!   Fortran
!u# https://rosettacode.org/wiki/Perlin_noise
!c# 2024-01-11 
...
REAL*8 FUNCTION NOISE(x_in, y_in, z_in)
...
REAL*8 FUNCTION FADE(t)
    REAL*8, INTENT(IN) :: t

    FADE = t ** 3 * (t * ( t * 6 - 15) + 10)
END FUNCTION

REAL*8 FUNCTION LERP(t, a, b)
    REAL*8, INTENT(IN) :: t, a, b

    LERP = a + t * (b - a)
END FUNCTION

REAL*8 FUNCTION GRAD(hash, x, y, z)
