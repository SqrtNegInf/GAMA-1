...
FC="gfortran"
FCFLAGS="-std=f2008 -g -O3 -march=native -fno-stack-protector -Wall -Wextra ${FCCHECK}"

# doesn't have 128-bit implemented, hence mod to source .f90 (kind11x11)
#FC="flang-new-mp-17"
#FCFLAGS="-g -O3 ${FCCHECK}"
